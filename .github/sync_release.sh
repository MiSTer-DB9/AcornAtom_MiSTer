...
UPSTREAM_REPO="https://github.com/MiSTer-devel/AcornAtom_MiSTer.git"
CORE_NAME=(AcornAtom)
...
UPSTREAM_CORE_NAME=(AcornAtom)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(AcornAtom.qpf)
COMPILATION_OUTPUT=(output_files/AcornAtom.rbf)
